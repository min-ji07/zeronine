...
<body>
   ...
   <div id="item2BackGround">
      <a id="showHere"></a>
      <form name="productform" method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/productUpdate2.do?pno=<%=p.getPno()%>">
         <div id="item2Container">
            <!-- 이 부분에서 작업 -->
            <input type="hidden" value="<%= m.getUserId() %>" name="writerId">
            <div id="itemAddTitle2"><br>수정할 상품의 정보를 입력해주세요</div>
                  ...
                  <fieldset class="formRow" id="fieldset1">
                     <div class="formRow--item">
                        <label class="formRow--input-wrapper js-inputWrapper"
                           ...
                           placeholder="상품명" value="<%=p.getMainTitle()%>">
                        </label>
                     </div>
                  </fieldset>
                  <fieldset class="formRow" id="fieldset2">
                     <div class="formRow--item">
                        <label class="formRow--input-wrapper js-inputWrapper"
                           ...
                           class="formRow--input js-input" id="lastname" placeholder="판매가" value="<%=p.getMainPrice()%>"
                           onkeypress="inNumber();">
                        </label>
                        <!-- ==============================================================================-->
                        <!-- =============== 옵션추가 라인 시작 =============================================-->
            ...
            <div id="addItemButton1">
               ...
               <button id='btn-upload' class="button1 white selected" onclick="productInsert();" onfocus="this.blur();">수정하기</button>
            </div>
      </form>
      <a id="showHere"></a>
   </div>
