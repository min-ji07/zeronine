                ...
                <div style="padding-top:30px;margin:0 auto;">
                    ...
                    <div class="container">
                        <div class="signup-content">
                            <form method="POST" id="signup-form" name="signform" class="signup-form" action="<%=request.getContextPath()%>/MemberUpdateServlet.do">
                                ...
                                <div class="form-group">
                                    <input type="password" class="form-input" name="userPwd" id="password" minlength=8
                                        maxlength=20 placeholder="비밀번호 입력 (8 ~ 20 자리 이하)" />
                                ...
                                <div class="form-group">
                                    <input type="email" class="form-input" name="email" id="email" value="<%= m.getEmail() %>" />
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-input2" name="address1" id="address1" value="<%= m.getAddress1() %>">
                                ...
                                <div class="form-group"> <input type="text" class="form-input3" name="address2" id="address2"
                                        value="<%= m.getAddress2() %>"></div>
                                <div class="form-group"> <input type="text" class="form-input3" name="address3" id="address3"
                                        value="<%= m.getAddress3() %>"></div>
        
                                <div class="form-group" style="margin-top:40px;">
                                    <a href="<%=request.getContextPath()%>/views/myPage.jsp"></a> 
                                    <input type="submit" name="submit" id="submit" class="form-submit" value="개인정보수정" onclick="return insertUpdate();">
                                </div>
                            </form>
                        </div>
                    </div>
   ...
   <%@ include file="common/footer.jsp" %>
    ...
    <script type="text/javascript">
       function insertUpdate() {
           ...
           var form2 = document.getElementById('re_password');
           ...
           if(form.value == null || form.value == "" ){
              ...
              form.focus();
              return false;
           }else if(form2.value == null || form2.value == ""){
             ...
             email.select();
             return false;
           }else if(address2.value == null || address2.value == ""){
              alert("주소를 입력해주세요 2");
             email.select();
             return false;
           }else if(address3.value == null || address3.value == ""){
              alert("주소를 입력해주세요 3");
             email.select();
             return false;
           }
